...
class PhoneLoginOTPVerification extends StatefulWidget {
  final String phone;

  const PhoneLoginOTPVerification({Key? key, required this.phone}) : super(key: key);

  @override
  _PhoneLoginOTPVerificationState createState() => _PhoneLoginOTPVerificationState();
}

class _PhoneLoginOTPVerificationState extends State<PhoneLoginOTPVerification> {
