...
class _ChatState extends State<Chat> {
  final List<Message> messages = [
    ...
    Message(
        sender: 'User1',
        time: '3:02 PM',
        text: 'I am new on this application and i saw your profile ',
        isMe: false),
    Message(sender: 'User2', time: '2:55 PM', text: 'I’m good', isMe: true),
    Message(
        sender: 'User2',
        time: '3:02 PM',
        text: 'You also have a very interesting profile let’s talk',
        isMe: true),
  ];
