...
// import 'package:bnn/screens/livestream/call_screen.dart';
...
//               onPressed: () async {
//                 // String callId = "sm23C4G9eBqO";
//                 // final result = await livestreamProvider.joinCall();

//                 final callId = "sm23C4G9eBq2";

//                 final call = StreamVideo.instance.makeCall(
//                     callType: StreamCallType.defaultType(), id: callId);

//                 var result = await call.getOrCreate();
//                 await call.join();
